    ...
    <div class="container">
    	<div class="row row-centered"> 
           <div class="col-lg-6 col-centered">  
				   ...
				   <p> Las instalaciones se encuentran en la localidad de Pujato, en el sur de la provincia de Santa Fe. En nuestro sitio contamos con el apartado <a href="ubicacion.php"> Ubicación </a> que muestra un mapa con la localización exacta.</p>
				   <h3>¿Como puedo reservar el salon de fiestas?</h3>
